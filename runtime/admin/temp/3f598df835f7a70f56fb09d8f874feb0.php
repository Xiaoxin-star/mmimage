<?php /*a:1:{s:66:"C:\Users\Lenovo\Desktop\项目\tp6\app\admin\view\index\index.html";i:1621748135;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-body">
    <div class="login-main">
        ...
        <form class="layui-form login-bottom" method="post" action="<?php echo url('index'); ?>">
            <div class="center">
                <div class="item">
                ...
                <div id="validatePanel" class="item" style="width: 137px;">
                    ...
                    <img id="refreshCaptcha" class="validateImg" placeholder="请输入验证码" src="<?php echo captcha_src(); ?>"
...
<script>
    console.log("<?php echo url('admin/login'); ?>")
