<?php /*a:1:{s:59:"C:\Users\Lenovo\Desktop\tp6\app\admin\view\index\login.html";i:1621781919;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
      ...
      <ul class="layui-nav layui-layout-right">
        ...
        <li class="layui-nav-item layuimini-setting">
          ...
          <dl class="layui-nav-child">
            <dd>
              <a href="javascript:;" layuimini-content-href="<?php echo url('admin/index/setting'); ?>"
                 data-title="基本资料" data-icon="fa fa-gears">基本资料<span class="layui-badge-dot"></span></a>
            </dd>
            <dd>
              <a href="javascript:;" layuimini-content-href="<?php echo url('admin/index/password'); ?>"
            ...
            <dd>
              <a href="/admin/index/out.html" class="login-out">退出登录</a>
            </dd>
          </dl>
        </li>
...
<!--        var options = {-->
<!--            iniUrl: '<?php echo url("Api/init"); ?>',                  // 初始化接口-->
<!--            clearUrl: '<?php echo url("Api/clear"); ?>',                // 缓存清理接口-->
